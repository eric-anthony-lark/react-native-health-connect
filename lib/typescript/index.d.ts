 ...
 */
export declare function requestPermission(permissions: (Permission | WriteExerciseRoutePermission | ReadHealthDataHistoryPermission | ReadHealthDataInBackgroundPermission)[]): Promise<Permission[]>;
